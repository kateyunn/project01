$(document).ready(function(){
	...
	$("section").on("mousemove",function(e){		
		...
		$(".p11").css({"right":565-(posX/50) , "bottom":40-(posY/50) });
		$(".p12").css({"right":400+(posX/40) , "top":60+(posY/40) });
		$(".p13").css({"right":400+(posX/30) , "top":-180+(posY/30) });		
		$(".p14").css({"right":610+(posX/20) , "top":38+(posY/20) });		
		$(".p15").css({"right":330+(posX/8) , "top":550+(posY/8) });		
	
		//두 번째 박스의 이미지 위치값을 마우스 커서의 위치값과 연동
		$("section:nth-child(1) p ").css({"left":670+(posX/20) , "top":20+(posY/20) });	
		$("section:nth-child(1) span ").css({"left":750+(posX/20) , "top":90+(posY/20) });	
